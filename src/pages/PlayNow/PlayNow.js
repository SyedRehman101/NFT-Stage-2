...
const PlayNow = () => {
  return (
    <div className='h-[83.5vh]' style={{ backgroundImage: `url(${playBg})`, backgroundPosition: 'bottom', backgroundSize: 'cover' }}>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1">
          <div className="banner_left relative text-center">
            <div className='img_container relative w-[220px] h-[130px]'>
              <p className='text-pure text-lg title mb-4'><span className='mr-4'>Recruit</span> laaverse</p>
            ...
            <div className='content mt-32'>
              <p className='text-pure lg:text-xl text-md font-bold mb-2 flex items-center'><img className='mr-3' src={nft} alt="" /> <a href="/landmap">NFT LAND</a></p>
              <p className='text-pure lg:text-xl text-md font-bold mb-2 flex items-center'><img className='mr-3' src={exchange} alt="" /><a href="/dao">Exchange</a></p>
              <p className='text-pure lg:text-xl text-md font-bold mb-2 flex items-center'><img className='mr-3' src={ch} alt="" /><a href="/nftmarket">Characters</a></p>
              <p className='text-pure lg:text-xl text-md font-bold mb-2 flex items-center'><img className='mr-3' src={bag} alt="" /><a href="/nftmarket">Market place</a></p>
            </div>
          ...
          <div className="banner_right relative">
            <div className='flex w-[320px] justify-between items-center top_right'>
              <div>
                <div className='flex items-center mb-4 circle_star'>
                  ...
                  <BsPlus className='ml-16 text-2xl text-amber-300 font-bold' />
                </div>

                <div className='flex items-center '>
                  <img className='w-6' src={dimond} alt="" />
                  <p className='ml-4 text-lg font-bold text-sky-500'>0</p>
                  <BsPlus className='ml-16 text-2xl text-sky-500 font-bold' />
                </div>
              </div>
            ...
            <div className="content_top w-[325px] bg-[#120848]/[.4] p-2 rounded-lg">
            ...
            <div className="content_bottom h-[270px] lg:w-[220px] w-[150px] bg-[#1A084D]/[.7] rounded-lg border">
              ...
              <div className='absolute bottom-1 left-2/4 translate-x-[-50%]'>
                <p className='text-pure font-bold lg:text-lg text-sm text-center'>ARCADE</p>
              </div>
